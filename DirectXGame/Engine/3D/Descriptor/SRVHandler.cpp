...
void SRVHandler::AddPtr(uint32_t index, D3D12_DESCRIPTOR_HEAP_TYPE type)
{
...
D3D12_CPU_DESCRIPTOR_HANDLE SRVHandler::GetSrvHandleCPU(ID3D12DescriptorHeap* descriptorheap, uint32_t descriptorSize, uint32_t index)
{
...
D3D12_GPU_DESCRIPTOR_HANDLE SRVHandler::GetSrvHandleGPU(ID3D12DescriptorHeap* descriptorheap, uint32_t descriptorSize, uint32_t index)
{
