...
Particle BossDamage(RandomGenerator generator, float32_t3 emitterPosition)
{
    ...
    //particle.translate *= 3.0f;
    particle.translate += emitterPosition;
    particle.translate.z = emitterPosition.z;
    //particle.color.rgb = generator.GenerateRange3D(float32_t3(0.0f, 0.95f, 0.95f), float32_t3(0.05f, 1.0f, 1.0f));
    particle.color.rgb = generator.GenerateRange3D(float32_t3(0.95f, 0.0f, 0.0f), float32_t3(1.0f, 0.1f, 0.1f));
...
Particle BossBarrierBreak(RandomGenerator generator, float32_t3 emitterPosition)
{
    float32_t3 test = generator.Generate3D();
    Particle particle = (Particle) 0;
    float32_t maxSize = 4.0f;
    ...
    //particle.translate.z = emitterPosition.z;
    //particle.color.rgb = generator.GenerateRange3D(float32_t3(0.0f, 0.95f, 0.95f), float32_t3(0.05f, 1.0f, 1.0f));
    particle.color.rgb = generator.GenerateRange3D(float32_t3(0.0f, 0.85f, 0.0f), float32_t3(0.1f, 1.0f, 0.1f));
    particle.color.a = generator.GenerateRange1D(float32_t(0.5f), float32_t(0.75f));
